...
% 	\rfoot{Halaman \thepage}%
    ...
    % Judul Tugas Akhir
    \title{PERANCANGAN SISTEM LOKER HELM PINTAR BERBASIS INTERNET OF THINGS (IOT) DENGAN OTENTIKASI APLIKASI MOBILE DAN PREDIKSI KETERSEDIAAN MENGGUNAKAN MACHINE LEARNING} % Judul Tugas Akhir dalam Bahasa Indonesia	
